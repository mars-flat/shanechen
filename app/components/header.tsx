        ...
        <div className="w-[85%] h-full flex justify-between items-center">
          ...
          <div className="max-md:hidden md:w-[40%] lg:w-[30%] xl:w-[25%]">
            <ul className="flex justify-between flex-wrap items-center">
              <li><Link href="#projects" className={theme.tw.textWhite + " hover:text-xl transition-text duration-200"}>Projects</Link></li>
              <li><Link href="/resume.pdf" className={theme.tw.textWhite + " hover:text-xl transition-text duration-200"} target="_blank">Résumé</Link></li>
          ...
          {isMenuOpen &&
            <div className={theme.tw.bgBlack + " max-md:block md:hidden absolute top-[10vh] left-0 w-full " + theme.tw.textWhite}>
              <ul className="h-[15vh] w-[90%] flex flex-col items-end">
                <li><Link href="#projects" className="!text-white hover:text-xl mb-2">Projects</Link></li>
                <li><Link href="/resume.pdf" className="!text-white hover:text-xl mb-2" target="_blank">Résumé</Link></li>
