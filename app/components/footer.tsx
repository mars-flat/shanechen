    ...
    <div className="h-[50vh] bg-black p-[2%] flex flex-col items-center">
      <div className="w-full h-[80%] text-white p-[1%] flex justify-center">
        <div className="h-[80%] w-[35%] p-4">
          ...
          <p className="text-xl mb-[10%]">Connect with me using the social links on the right or email
            me at <a href="mailto:zshanechen@gmail.com" className="text-green-600">zshanechen@gmail.com</a>. Let's chat!</p>
